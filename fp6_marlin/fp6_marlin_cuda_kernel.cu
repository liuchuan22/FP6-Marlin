 ...
 *
 * This file is based on code from Marlin, https://github.com/IST-DASLab/marlin/blob/master/marlin/marlin_cuda_kernel.cu
 * Copyright (C) Marlin.2024 Elias Frantar (elias.frantar@ist.ac.at)
 * Large modifications were made by Chuan Liu (Add support for 6 bit quantization)
 * 
